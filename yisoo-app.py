...
st.markdown("""
    ...
    * { font-weight: bold !important; font-family: 'Nanum Gothic', sans-serif; color: #263238; }
    ...
    /* 제목 글씨 스타일 */
    .title-text { font-size: 32px !important; color: #1565C0 !important; margin-bottom: 10px; display: block; border-left: 10px solid #1565C0; padding-left: 15px; }
    
    /* [박스 살리기] 알맹이만 담는 정보 박스 */
    .info-card { background-color: #FFFFFF; padding: 25px; border-radius: 15px; border: 3px solid #CFD8DC; margin-bottom: 25px; }
...
# [수정] 글로벌 전황: 빈 박스 없이 제목과 수치를 한 통에 넣기
def display_global_risk():
    try:
        ...
        # [핵심] 박스를 먼저 열고 그 안에 제목을 넣어야 빈 박스가 안 생깁니다!
