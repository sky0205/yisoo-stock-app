...
def display_global_risk():
    try:
        ...
        elif n_chg < -1.0: advice = f"🚨 **[긴급 상황: 정박!]** 나스닥 {n_chg:.2f}% 급락에 비명 소리가 자자하네! 성벽 함락 위기니 무리한 진격은 금물일세."
...
symbol = st.text_input("📊 분석할 종목번호 또는 티커 입력", "GOOGL")
