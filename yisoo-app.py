...
st.markdown("""
    ...
    /* 지표 제목(Metric Label) 굵게 강조 */
    [data-testid="stMetricLabel"] { font-size: 20px !important; font-weight: 900 !important; color: #000000 !important; }
...
st.title("👨‍💻 이수할아버지의 '명품' 분석기 v32000")
