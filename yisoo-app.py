    ...
    try:
        ...
        if df.empty:
            ...
            if is_squeeze:
                ...
                squeeze_info_str = f"<br>• 🌊 <b>[밴드폭 넉넉함({bandwidth:.1f}%)]</b> 활주로가 넉넉히 트였..."
            ...
            if is_stop_loss_triggered:
                ...
                col = "#F57C00"
                final_adv = f"• <b>[최종 결론]</b> 보정강도({vol_strength:.1f}점). <b>[지표 미흡]</b> 5일선은 안착했으나 보조지표 동조 점수 부족으로 외바닥 속임수를 경계하고 관망하시게."
