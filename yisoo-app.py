    ...
    try:
        ...
        if df.empty:
           ...
           # 전일 종가 변수는 위에서 확정한 prev_p를 사용한다.
            ...
            # ==================================================================
            # ★ [신호등 분기 논리 - 원본 8단계 및 혼조세 매수 타점 완벽 복원 통합본]
            # ==================================================================
            try:
            ...
            # 4순위: 성벽 위 전용 전황 판정 (양봉 진격 vs 음봉 조정)
            elif p >= defense_line:
            ...
            # 5순위: 1단계 진바닥 입질 (성벽 아래여도 바닥 지표 + 수급 충족 시 정찰병 타진 허용)
            ...
            # 9순위: ★ [혼조세 속 진바닥 입질 예외 가드]: 이평선 꼬임 속 수급·밴드 충족 시 1단계 매수 허용
            elif is_ma_tangled:
