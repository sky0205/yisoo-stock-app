...
if symbol:
    try:
        ...
        if df.empty:
            ...
            # ★ [5일선 이격도(+3% 초과) 계산]: 이격 과열 여부 판단 (1순위 제어)
            ...
            elif is_near_wall: # ★ 3순위: 성벽 돌파 공방 중일 때는 진격 유지
            ...
            if final_code == "STOP_LOSS_ALERT":
                ...
                col = "#1E88E5"
                s_adv = f"• <b>[성벽 돌파 공방 중]</b> 현재 성벽({defense_line:{fmt_p}}{currency}) 돌파 시도 중이오. 기세를 살려 5일선 기준으로 살피시게.<br>• 🚀 <b>[필수 방어선]</b> {stop_loss_label}"
