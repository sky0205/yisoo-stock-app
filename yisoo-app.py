    ...
    try:
        ...
        if not df.empty:
            ...
            with i1: # Bollinger
                ...
                bb_diag = f"● 현재 **중앙선 위**에서 기세를 타는 중입니다. 상단 성벽 돌파 시도는 긍정적이나, 실패 시 중앙선까지 밀릴 수 있으니 주의하십시오." if bb_pos=="⚖️ 눈치보기(상)" else f"● 현재 **중앙선 아래**에서 빌빌대고 있습니다. 하단 성벽까지 밀릴 위험이 크니 섣부른 진격은 금물입니다." if bb_pos=="⚖️ 눈치보기(하)" else f"● 성벽 밖 **과열 권역**입니다. 수익 실현 소나기가 올 수 있으니 보따리 쌀 준비 하십시오." if bb_pos=="🔥 폭주" else f"● 하단 성벽이 무너진 **공포 구간**입니다. 투매 비명소리가 잦아들 때까지 절대 칼날을 잡지 마십시오."
