...
# 1. 화면 구성 및 할배 캐릭터 스타일 (완전 일체형 박스 레이아웃)
...
st.markdown("""
    ...
    * { font-weight: bold !important; font-family: 'Nanum Gothic', sans-serif; color: #263238; }
    ...
    /* 신호등 */
    .signal-box { padding: 40px; border-radius: 25px; text-align: center; margin-bottom: 30px; }
    ...
    [data-testid="stMetricLabel"] { font-size: 28px !important; color: #546E7A !important; }
    </style>
...
def display_global_risk():
    try:
        ...
        advice = "✅ **[미장 쾌청: 진격!]** 나스닥 불 뿜고 금리도 안정세일세!" if n_chg > 0.5 else "🚨 **[긴급 상황: 정박!]** 비명 소리 나니 일단 피신하시게."
    ...
    try:
        ...
        if not df.empty:
            ...
            if v_ratio >= 30 and is_opening:
                ...
                v_adv = f"🔥 **[세력 진격!]** 거래량이 빳빳하게 터지며 폭등 중일세! 기세 타시게!" if p_chg >= 3 else f"💀 **[비명 포착!]** 거래량이 {v_ratio:.1f}% 터지며 폭락 중일세! 일단 피신하시게!"
            else:
