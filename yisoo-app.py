...
# [수선 완료] 꼴 보기 싫던 빈 공간 싹 걷어낸 글로벌 지표
def display_global_risk():
    try:
        ...
        # 제목 글씨 바로 밑에 텅 빈 박스 생기지 않게 딱 붙였음
        ...
        if n_chg > 0.5: advice = "✅ **[미장 쾌청: 진격!]** 나스닥 기세 좋구먼! 기운 내시게."
        elif n_chg < -1.0: advice = "🚨 **[긴급 상황: 정박!]** 비명 소리 나니 몸을 사리시게."
